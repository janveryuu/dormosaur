...
export function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true" width="18" height="18" {...props}>
      <path
        fill="#4285F4"
      ...
      <path
        fill="#FBBC05"
        d="M11.68 28.18A13.94 13.94 0 0 1 10.95 24c0-1.45.25-2.86.73-4.18v-5.7H4.34A21.94 21.94 0 0 0 2 24c0 3.55.85 6.91 2.34 9.88l7.34-5.7Z"
      />
      <path
        fill="#EA4335"
